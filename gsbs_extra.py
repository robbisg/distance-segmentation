...
class GSBS:
    def __init__(self, kmax: int, x: ndarray, dmin: int = 1, y: Optional[ndarray] = None, 
                       blocksize: Optional[int] = 50, 
                 outextra: Optional[bool] = False, 
                 finetune:Optional[int] = 1) -> None:
        """
